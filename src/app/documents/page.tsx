...
const docs: Doc[] = [
  {
    ...
    href: "https://drive.google.com/file/d/1efkgkMCVyfuYd_oaK6OjzRFQfrg31hDE/view?usp=sharing",
  ...
  },
  {
    ...
    href: "/docs/proposal-document.pdf",
...
const checklists: Doc[] = [
  {
    ...
    href: "https://drive.google.com/file/d/1SoqotKSx_FMs7Z-x6cOly-oU3-W0GqEz/view?usp=sharing",
...
const finalDocs: Doc[] = [
  {
    ...
    href: "/docs/final-document-01.pdf",
  ...
  },
  {
    ...
    href: "/docs/final-document-02.pdf",
  ...
  },
  {
    ...
    href: "/docs/final-document-03.pdf",
  ...
  },
  {
    ...
    href: "/docs/final-document-04.pdf",
    ...
    >
      <div className="space-y-16">
        ...
        <section>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {docs.map((doc, i) => (
              <FadeIn key={doc.href} delay={i * 0.04}>
        ...
        <section>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {checklists.map((doc, i) => (
              <FadeIn key={doc.href} delay={i * 0.05}>
                <DocumentCard doc={doc} />
              </FadeIn>
            ))}
          </div>
      ...
      <div className="mt-20 grid gap-8 lg:grid-cols-12">
        <FadeIn className="lg:col-span-7">
          <div className="bg-linear-to-br from-emerald-50 to-white border border-emerald-100 rounded-3xl p-10">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              ...
              <div className="flex gap-5">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1">Saves file to your device</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <FadeIn className="lg:col-span-5" delay={0.05}>
          <div className="bg-white border border-emerald-100 rounded-3xl p-10">
            ...
            <p className="text-slate-600">
              Place your PDF files inside the <span className="font-mono bg-emerald-50 px-2 py-1 rounded">public/docs</span> folder.
            </p>
            <div className="mt-6 text-xs text-slate-500">
              Tip: If any link shows 404, ensure the file is placed in the <span className="font-medium">public/docs</span> directory.
            </div>
          </div>
        </FadeIn>
      </div>
...
function DocumentCard({ doc }: { doc: Doc }) {
  return (
    <div className="group bg-white border border-emerald-100 rounded-3xl p-8 hover:border-emerald-300 hover:shadow-xl transition-all duration-300 flex flex-col">
      {/* Subtle top accent */}
      <div className="h-1 bg-linear-to-r from-emerald-400 to-teal-500 rounded-t-3xl -mx-8 -mt-8 mb-6" />
      ...
      <div className="flex items-start justify-between">
        ...
        {doc.tag && (
          <span className="px-4 py-1 text-xs font-medium bg-emerald-100 text-emerald-700 rounded-full">
            {doc.tag}
          </span>
        )}
      </div>
      ...
      <div className="mt-8 flex gap-3">
        <Link
          ...
          className="flex-1 h-10 flex items-center justify-center gap-2 rounded-2xl border border-emerald-200 hover:bg-emerald-50 text-slate-700 hover:text-emerald-700 font-medium text-sm transition-all"
        >
        ...
        <a
          ...
          className="flex-1 h-10 flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-sm transition-all"
        >
